  ...
  return (
    ...
    >
      ...
      >
        ...
        developer building modern web apps.
      </motion.h1>
      <motion.p
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        A professional developer based in Bangladesh. I&#39;m passionate about
        building modern web applications using Python, Django, Node JS,
